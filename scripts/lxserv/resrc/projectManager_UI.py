...
#
# Created: Tue Jul  1 21:45:54 2014
...
"")
        ...
        self.fileTypeCombo = QtGui.QComboBox(self.layoutWidget1)
        ...
        self.fileTypeCombo.setMinimumSize(QtCore.QSize(100, 20))
        self.fileTypeCombo.setMaximumSize(QtCore.QSize(16777215, 90))
        self.fileTypeCombo.setMouseTracking(False)
        self.fileTypeCombo.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fileTypeCombo.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.fileTypeCombo.setStyleSheet("min-height: 18px;")
        self.fileTypeCombo.setMaxVisibleItems(15)
        ...
        self.fileTypeCombo.addItem("")
        self.fileTypeCombo.addItem("")
        self.gridLayout_4.addWidget(self.fileTypeCombo, 0, 3, 1, 1)
        ...
        self.newProjectPathButton = QtGui.QPushButton(self.projectLocationGroup)
        self.newProjectPathButton.setMinimumSize(QtCore.QSize(51, 20))
        self.newProjectPathButton.setMaximumSize(QtCore.QSize(30, 20))
        self.newProjectPathButton.setStyleSheet("min-width: 45px;")
        self.newProjectPathButton.setObjectName("newProjectPathButton")
        self.gridLayout_2.addWidget(self.newProjectPathButton, 0, 2, 1, 1)
        ...
        self.folderTemplateCombo = QtGui.QComboBox(self.rootFoldersGroup)
        self.folderTemplateCombo.setMinimumSize(QtCore.QSize(0, 20))
        self.folderTemplateCombo.setMaximumSize(QtCore.QSize(16777215, 20))
        self.folderTemplateCombo.setObjectName("folderTemplateCombo")
        self.folderTemplateCombo.addItem("")
        self.gridLayout.addWidget(self.folderTemplateCombo, 1, 1, 1, 1)
        self.newTemplateButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.newTemplateButton.sizePolicy().hasHeightForWidth())
        self.newTemplateButton.setSizePolicy(sizePolicy)
        self.newTemplateButton.setMinimumSize(QtCore.QSize(0, 20))
        self.newTemplateButton.setMaximumSize(QtCore.QSize(40, 20))
        self.newTemplateButton.setObjectName("newTemplateButton")
        self.gridLayout.addWidget(self.newTemplateButton, 1, 2, 1, 1)
        ...
        self.addFolderButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.addFolderButton.setMaximumSize(QtCore.QSize(40, 20))
        self.addFolderButton.setObjectName("addFolderButton")
        self.verticalLayout.addWidget(self.addFolderButton)
        self.removeFolderButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.removeFolderButton.sizePolicy().hasHeightForWidth())
        self.removeFolderButton.setSizePolicy(sizePolicy)
        self.removeFolderButton.setMaximumSize(QtCore.QSize(40, 20))
        self.removeFolderButton.setObjectName("removeFolderButton")
        self.verticalLayout.addWidget(self.removeFolderButton)
        self.resetTreeButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.resetTreeButton.sizePolicy().hasHeightForWidth())
        self.resetTreeButton.setSizePolicy(sizePolicy)
        self.resetTreeButton.setMaximumSize(QtCore.QSize(40, 20))
        self.resetTreeButton.setObjectName("resetTreeButton")
        self.verticalLayout.addWidget(self.resetTreeButton)
        self.saveTemplateButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.saveTemplateButton.sizePolicy().hasHeightForWidth())
        self.saveTemplateButton.setSizePolicy(sizePolicy)
        self.saveTemplateButton.setMaximumSize(QtCore.QSize(40, 20))
        self.saveTemplateButton.setObjectName("saveTemplateButton")
        self.verticalLayout.addWidget(self.saveTemplateButton)
        self.saveTemplateAsButton = QtGui.QPushButton(self.rootFoldersGroup)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.saveTemplateAsButton.sizePolicy().hasHeightForWidth())
        self.saveTemplateAsButton.setSizePolicy(sizePolicy)
        self.saveTemplateAsButton.setMaximumSize(QtCore.QSize(40, 20))
        self.saveTemplateAsButton.setObjectName("saveTemplateAsButton")
        self.verticalLayout.addWidget(self.saveTemplateAsButton)
        ...
        self.createProjectButton = QtGui.QPushButton(self.newProjectTab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.createProjectButton.setMinimumSize(QtCore.QSize(150, 0))
    ...
    def retranslateUi(self, projectManager):
        ...
        self.fileTypeCombo.setItemText(0, QtGui.QApplication.translate("projectManager", "Modo (*.lxo)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(1, QtGui.QApplication.translate("projectManager", "Preset (*.lxl)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(2, QtGui.QApplication.translate("projectManager", "Lightwave (*.lwo)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(3, QtGui.QApplication.translate("projectManager", "Wavefront (*.obj)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(4, QtGui.QApplication.translate("projectManager", "Alembic (*.abc)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(5, QtGui.QApplication.translate("projectManager", "Filmbox (*.fbx)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(6, QtGui.QApplication.translate("projectManager", "Collada (*.dae)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(7, QtGui.QApplication.translate("projectManager", "Rhino (*.3dm)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(8, QtGui.QApplication.translate("projectManager", "Autodesk DXF (.*dxf)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(9, QtGui.QApplication.translate("projectManager", "Adobe Illustrator (*.eps, *.ai)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(10, QtGui.QApplication.translate("projectManager", "Stereolithography (*.stl)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(11, QtGui.QApplication.translate("projectManager", "Videoscape (*.geo)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(12, QtGui.QApplication.translate("projectManager", "Solidworks (*.sldprt, *.sldasm)", None, QtGui.QApplication.UnicodeUTF8))
        self.fileTypeCombo.setItemText(13, QtGui.QApplication.translate("projectManager", "Protein DB (*.pdb)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.newProjectPathButton.setToolTip(QtGui.QApplication.translate("projectManager", "Browse for the location of your new project. The title of the project will be the directory you choose.", None, QtGui.QApplication.UnicodeUTF8))
        self.newProjectPathButton.setText(QtGui.QApplication.translate("projectManager", "...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.folderTemplateCombo.setItemText(0, QtGui.QApplication.translate("projectManager", "Modo Default", None, QtGui.QApplication.UnicodeUTF8))
        self.newTemplateButton.setText(QtGui.QApplication.translate("projectManager", "New", None, QtGui.QApplication.UnicodeUTF8))
        self.scenesRootLabel_2.setText(QtGui.QApplication.translate("projectManager", "Structure", None, QtGui.QApplication.UnicodeUTF8))
        self.addFolderButton.setText(QtGui.QApplication.translate("projectManager", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.removeFolderButton.setText(QtGui.QApplication.translate("projectManager", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.resetTreeButton.setText(QtGui.QApplication.translate("projectManager", "Reset", None, QtGui.QApplication.UnicodeUTF8))
        self.saveTemplateButton.setText(QtGui.QApplication.translate("projectManager", "Save", None, QtGui.QApplication.UnicodeUTF8))
        self.saveTemplateAsButton.setText(QtGui.QApplication.translate("projectManager", "S. As", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.createProjectButton.setText(QtGui.QApplication.translate("projectManager", "Create Project", None, QtGui.QApplication.UnicodeUTF8))
